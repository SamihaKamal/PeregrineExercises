...
namespace CRUDonAngular {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string Name, int Age) {
...
namespace CRUDonAngular.NorthwindDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([StudentId] = @Original_StudentId) AND ((@IsN" +
                "ull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Name], [Age]) VALUES (@Name, @Age);\r\nSELECT Student" +
                "Id, Name, Age FROM Student WHERE (StudentId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Age] = @Age WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT StudentId, Name, Age FROM Student WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUDonAngular.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, Name, Age FROM dbo.Student";
        ...
        public virtual int Fill(NorthwindDataSet.StudentDataTable dataTable) {
        ...
        public virtual NorthwindDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NorthwindDataSet.StudentDataTable dataTable = new NorthwindDataSet.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NorthwindDataSet.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentId, string Original_Name, global::System.Nullable<int> Original_Age) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Age, int Original_StudentId, string Original_Name, global::System.Nullable<int> Original_Age, int StudentId) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Age, int Original_StudentId, string Original_Name, global::System.Nullable<int> Original_Age) {
            return this.Update(Name, Age, Original_StudentId, Original_Name, Original_Age, Original_StudentId);
        }
    }
